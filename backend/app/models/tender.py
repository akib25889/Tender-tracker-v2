...
class Tender(Base):
    ...
    stage = Column(String(50), nullable=True, default="DISCOVERED", index=True)
    decision = Column(String(50), nullable=True, default="PENDING", index=True)
    ...
    schedule_purchase_method = Column(String(255), nullable=True)
    tender_security_amount = Column(Float, nullable=True)
    tender_security_method = Column(String(255), nullable=True)
