...
export const TenderProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  const addTender = (tenderData: Partial<Tender>) => {
    ...
    const newTender: Tender = {
      ...
      publishedHour: tenderData.publishedHour,
      publishedMinute: tenderData.publishedMinute,
      publishedTimezone: tenderData.publishedTimezone,
      closeHour: tenderData.closeHour,
      closeMinute: tenderData.closeMinute,
      closeTimezone: tenderData.closeTimezone,
